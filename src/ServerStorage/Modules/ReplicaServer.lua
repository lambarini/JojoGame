...
export type Replica<T> = {
	...
	SetParent: (self: any, new_parent: Replica<T>) -> (),
	...
	Destroy: (self: any) -> (),
	NewReadyPlayer : typeof(Signal.new()),
}
...
function Replica.Token(name: string) : typeof(ReplicaToken)
...
function Replica.New<T>(params: {Token: typeof(ReplicaToken), Tags: {}?, Data: T, WriteLib: ModuleScript?}): Replica<T>
